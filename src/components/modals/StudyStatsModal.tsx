...
import StudyDashboardSkeleton from '@/components/features/study-dashboard/StudyDashboardSkeleton';
import { useStudyDashboardData } from '../../hooks/useStudyDashboardData';
import type { DisciplineBreakdownItem, StudyMetricCard, WeeklyStudyPoint } from '@/components/features/study-dashboard/types';
